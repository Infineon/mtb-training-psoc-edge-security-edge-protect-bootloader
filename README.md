# PSOC™ Edge E3 Training - Edge Protect Bootloader

This training is part of the PSOC™ Edge Security training series and focuses on Edge Protect Bootloader (EPB) and its key features in PSOC™ Edge devices.
This session provides a practical foundation for using a protected MCUboot-based bootloader to enable secure boot and authenticated, reliable firmware updates.
This training includes a hands-on lab providing practical experience with Edge Protect Bootloader. 
...
3. Running EPB from different memories
4. Lab: Secure Boot with Edge Protect Bootloader

## Expected outcome
- Get familiar with Edge Protect Bootloader and its features
